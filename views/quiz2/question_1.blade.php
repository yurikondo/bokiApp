...
@section('quizImg')
<img src="{{ asset('quizImg/sale_big_2.png') }}" alt="問題１" width="400">
@endsection

@section('question_text','なお、当社では商品売買に係る記帳方法として三分法を採用している。勘定科目は次の中から最も適当と思われるものを選ぶこと。')

@section('question', '商品50個を＠￥70で仕入れ、代金は現金で支払った。')

@section('answer_url')
<form action="{{ url('/quiz2/question_1') }}" method="POST">
  @endsection

  @section('debit_amount', '¥3,500')

  @section('credit_amount', '¥3,500')
